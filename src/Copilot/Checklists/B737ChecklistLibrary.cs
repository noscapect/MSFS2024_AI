    ...
    public static IReadOnlyList<ChecklistDefinition> GateToGate { get; } =
        new[]
        {
            ...
            Checklist("apu-start-pushback", "737 APU & Pushback Verification",
                ...
                new ChecklistItem("Ground power", "OFF", state => !state.ExternalPowerOn),
            ...
            Checklist("before-takeoff", "737 Before Takeoff Verification",
                ...
                Unknown("Cabin", "READY"),
                new ChecklistItem("Landing lights", "ON", state => state.LeftLandingLightSelectorPosition == 0 && state.RightLandingLightSelectorPosition == 0),
