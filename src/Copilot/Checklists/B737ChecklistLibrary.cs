    ...
    public static IReadOnlyList<ChecklistDefinition> GateToGate { get; } =
        new[]
        {
            Checklist("power-up-initial-setup", "737 Power Up Verification",
                ...
                new ChecklistItem("Fire tests", "COMPLETE", state => state.PmdgFireTestsCompleted),
            ...
            Checklist("flight-computer-preflight", "737 FMC & Pre-Flight Verification",
                ...
                new ChecklistItem("FMC TAKEOFF REF", "COMPLETE", state => state.BoeingFmcTakeoffReferenceComplete),
            ...
            Checklist("after-start-taxi", "737 After Start & Taxi Verification",
                new ChecklistItem("Electric hydraulic pumps", "ON", state => state.BoeingElectricHydraulicPumpsOn),
