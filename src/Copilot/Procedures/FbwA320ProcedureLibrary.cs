...
internal static class FbwA320ProcedureLibrary
{
    ...
    public static ProcedureDefinition PowerUpAndInitialSetup { get; } =
        new(
            ...
            new[]
            {
                ...
                Observe("captain-apu-bat", "Captain APU BAT ON", state => !state.IsIniBuildsA330 || state.ApuBatteryOn, CrewRole.Captain),
    ...
    public static ProcedureDefinition FlightComputerAndPreFlight { get; } =
        new(
            ...
            new[]
            {
                ...
                Automatic("fo-seatbelts-on", "Seatbelt signs ON", state => state.SeatbeltSignsOn, "seatbelts on"),
                ...
                Automatic(
                    ...
                    state => state.WeatherRadarPwsSelectorPosition.HasValue
                             && Math.Abs(
                                 ...
                                 - (state.IsFlyByWireAirbus || state.IsIniBuildsA330 ? 1 : 0)) < 0.1,
                    "wxr-pws 1",
    ...
    public static ProcedureDefinition ParkingAndShutdown { get; } =
        new(
            ...
            new[]
            {
                ...
                Automatic("fo-seatbelts-off", "Seatbelt signs OFF", state => !state.SeatbeltSignsOn, "seatbelts off"),
